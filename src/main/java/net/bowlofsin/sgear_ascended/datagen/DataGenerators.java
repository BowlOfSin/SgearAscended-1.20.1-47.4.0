...
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        generator.addProvider(event.includeServer(), new ModPoiTagTypesProvider(packOutput, lookupProvider, existingFileHelper));
    ...
    private static <T extends DataProvider> DataProvider.Factory<T> bindRegistries(
        ...
        return output -> pTagProviderFactory.apply(output, pLookupProvider);
    }
}
