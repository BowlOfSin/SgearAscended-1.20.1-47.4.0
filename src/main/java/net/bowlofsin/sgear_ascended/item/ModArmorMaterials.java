...
public enum ModArmorMaterials implements ArmorMaterial {
    ARCANITE("arcanite", 1000, new int[] { 150, 600, 450, 200}, 100,
            SoundEvents.ARMOR_EQUIP_NETHERITE, 100, 100, () -> Ingredient.of(ModItems.ARCANITE_INGOT.get()))
    ...
    public String getName() {
        return SGearAscendedMod.MODID+ ":" + this.name;
    }
